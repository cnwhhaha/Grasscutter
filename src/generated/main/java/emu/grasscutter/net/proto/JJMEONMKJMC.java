...
/**
 * <pre>
 * CmdId: - | MergeFrom: 0xE19D370 | WriteTo: 0xE19D630
 * </pre>
 *
 * Protobuf type {@code JJMEONMKJMC}
 */
public final class JJMEONMKJMC extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:JJMEONMKJMC)
    JJMEONMKJMCOrBuilder {
private static final long serialVersionUID = 0L;
  // Use JJMEONMKJMC.newBuilder() to construct.
  private JJMEONMKJMC(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private JJMEONMKJMC() {
        ...
        switch (tag) {
          ...
          case 50: {
            if (!((mutable_bitField0_ & 0x00000008) != 0)) {
              fetterList_ = new java.util.ArrayList<emu.grasscutter.net.proto.CLPOALNAMGC>();
              mutable_bitField0_ |= 0x00000008;
            }
            fetterList_.add(
                input.readMessage(emu.grasscutter.net.proto.CLPOALNAMGC.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_JJMEONMKJMC_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_JJMEONMKJMC_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            emu.grasscutter.net.proto.JJMEONMKJMC.class, emu.grasscutter.net.proto.JJMEONMKJMC.Builder.class);
  }
  ...
  private java.util.List<emu.grasscutter.net.proto.CLPOALNAMGC> fetterList_;
  /**
   * <code>repeated .CLPOALNAMGC fetter_list = 6;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.CLPOALNAMGC> getFetterListList() {
    return fetterList_;
  }
  /**
   * <code>repeated .CLPOALNAMGC fetter_list = 6;</code>
   */
  @java.lang.Override
  public java.util.List<? extends emu.grasscutter.net.proto.CLPOALNAMGCOrBuilder> 
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.CLPOALNAMGC getFetterList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.CLPOALNAMGCOrBuilder getFetterListOrBuilder(
      int index) {
    return fetterList_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof emu.grasscutter.net.proto.JJMEONMKJMC)) {
      return super.equals(obj);
    }
    emu.grasscutter.net.proto.JJMEONMKJMC other = (emu.grasscutter.net.proto.JJMEONMKJMC) obj;
  ...
  public static emu.grasscutter.net.proto.JJMEONMKJMC parseFrom(
  ...
  public static emu.grasscutter.net.proto.JJMEONMKJMC parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static emu.grasscutter.net.proto.JJMEONMKJMC parseFrom(
  ...
  public static emu.grasscutter.net.proto.JJMEONMKJMC parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static emu.grasscutter.net.proto.JJMEONMKJMC parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static emu.grasscutter.net.proto.JJMEONMKJMC parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(emu.grasscutter.net.proto.JJMEONMKJMC prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:JJMEONMKJMC)
      emu.grasscutter.net.proto.JJMEONMKJMCOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.proto.Proto4_8.internal_static_JJMEONMKJMC_descriptor;
    }
    ...
    // Construct using emu.grasscutter.net.proto.JJMEONMKJMC.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.JJMEONMKJMC getDefaultInstanceForType() {
      return emu.grasscutter.net.proto.JJMEONMKJMC.getDefaultInstance();
    }

    @java.lang.Override
    public emu.grasscutter.net.proto.JJMEONMKJMC build() {
      emu.grasscutter.net.proto.JJMEONMKJMC result = buildPartial();
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.JJMEONMKJMC buildPartial() {
      emu.grasscutter.net.proto.JJMEONMKJMC result = new emu.grasscutter.net.proto.JJMEONMKJMC(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof emu.grasscutter.net.proto.JJMEONMKJMC) {
        return mergeFrom((emu.grasscutter.net.proto.JJMEONMKJMC)other);
      } else {
    ...
    public Builder mergeFrom(emu.grasscutter.net.proto.JJMEONMKJMC other) {
      if (other == emu.grasscutter.net.proto.JJMEONMKJMC.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      emu.grasscutter.net.proto.JJMEONMKJMC parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (emu.grasscutter.net.proto.JJMEONMKJMC) e.getUnfinishedMessage();
    ...
    private void ensureFetterListIsMutable() {
      if (!((bitField0_ & 0x00000008) != 0)) {
        fetterList_ = new java.util.ArrayList<emu.grasscutter.net.proto.CLPOALNAMGC>(fetterList_);
        bitField0_ |= 0x00000008;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.CLPOALNAMGC, emu.grasscutter.net.proto.CLPOALNAMGC.Builder, emu.grasscutter.net.proto.CLPOALNAMGCOrBuilder> fetterListBuilder_;
    ...
    public Builder setFetterList(
        int index, emu.grasscutter.net.proto.CLPOALNAMGC value) {
      if (fetterListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setFetterList(
        int index, emu.grasscutter.net.proto.CLPOALNAMGC.Builder builderForValue) {
      if (fetterListBuilder_ == null) {
        ensureFetterListIsMutable();
     ...
     * <code>repeated .CLPOALNAMGC fetter_list = 6;</code>
     */
    public Builder addFetterList(emu.grasscutter.net.proto.CLPOALNAMGC value) {
      if (fetterListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addFetterList(
        emu.grasscutter.net.proto.CLPOALNAMGC.Builder builderForValue) {
      if (fetterListBuilder_ == null) {
        ensureFetterListIsMutable();
    ...
    public Builder addAllFetterList(
        java.lang.Iterable<? extends emu.grasscutter.net.proto.CLPOALNAMGC> values) {
      if (fetterListBuilder_ == null) {
        ensureFetterListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, fetterList_);
     ...
     * <code>repeated .CLPOALNAMGC fetter_list = 6;</code>
     */
    public emu.grasscutter.net.proto.CLPOALNAMGC.Builder getFetterListBuilder(
        int index) {
     ...
     * <code>repeated .CLPOALNAMGC fetter_list = 6;</code>
     */
    public emu.grasscutter.net.proto.CLPOALNAMGC.Builder addFetterListBuilder() {
      return getFetterListFieldBuilder().addBuilder(
          emu.grasscutter.net.proto.CLPOALNAMGC.getDefaultInstance());
    }
    /**
     * <code>repeated .CLPOALNAMGC fetter_list = 6;</code>
     */
    public emu.grasscutter.net.proto.CLPOALNAMGC.Builder addFetterListBuilder(
        int index) {
      return getFetterListFieldBuilder().addBuilder(
          index, emu.grasscutter.net.proto.CLPOALNAMGC.getDefaultInstance());
    }
    /**
     * <code>repeated .CLPOALNAMGC fetter_list = 6;</code>
     */
    public java.util.List<emu.grasscutter.net.proto.CLPOALNAMGC.Builder> 
         getFetterListBuilderList() {
      return getFetterListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.CLPOALNAMGC, emu.grasscutter.net.proto.CLPOALNAMGC.Builder, emu.grasscutter.net.proto.CLPOALNAMGCOrBuilder> 
        getFetterListFieldBuilder() {
      if (fetterListBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:JJMEONMKJMC)
  }

  // @@protoc_insertion_point(class_scope:JJMEONMKJMC)
  private static final emu.grasscutter.net.proto.JJMEONMKJMC DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new emu.grasscutter.net.proto.JJMEONMKJMC();
  }

  public static emu.grasscutter.net.proto.JJMEONMKJMC getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<JJMEONMKJMC>
      PARSER = new com.google.protobuf.AbstractParser<JJMEONMKJMC>() {
    @java.lang.Override
    public JJMEONMKJMC parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new JJMEONMKJMC(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<JJMEONMKJMC> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<JJMEONMKJMC> getParserForType() {
    return PARSER;
  }
