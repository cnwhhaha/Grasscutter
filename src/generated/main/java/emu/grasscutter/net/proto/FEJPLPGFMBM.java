...
/**
 * <pre>
 * CmdId: - | MergeFrom: 0xD7A8E00 | WriteTo: 0xD7A8B10
 * </pre>
 *
 * Protobuf type {@code FEJPLPGFMBM}
 */
public final class FEJPLPGFMBM extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:FEJPLPGFMBM)
    FEJPLPGFMBMOrBuilder {
private static final long serialVersionUID = 0L;
  // Use FEJPLPGFMBM.newBuilder() to construct.
  private FEJPLPGFMBM(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private FEJPLPGFMBM() {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            itemParam_ = input.readMessage(emu.grasscutter.net.proto.LIIBENDPBIH.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_FEJPLPGFMBM_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_FEJPLPGFMBM_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            emu.grasscutter.net.proto.FEJPLPGFMBM.class, emu.grasscutter.net.proto.FEJPLPGFMBM.Builder.class);
  }
  ...
  private emu.grasscutter.net.proto.LIIBENDPBIH itemParam_;
  /**
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.LIIBENDPBIH getItemParam() {
    return itemParam_ == null ? emu.grasscutter.net.proto.LIIBENDPBIH.getDefaultInstance() : itemParam_;
  }
  /**
   * <code>.LIIBENDPBIH item_param = 5;</code>
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.LIIBENDPBIHOrBuilder getItemParamOrBuilder() {
    return getItemParam();
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof emu.grasscutter.net.proto.FEJPLPGFMBM)) {
      return super.equals(obj);
    }
    emu.grasscutter.net.proto.FEJPLPGFMBM other = (emu.grasscutter.net.proto.FEJPLPGFMBM) obj;
  ...
  public static emu.grasscutter.net.proto.FEJPLPGFMBM parseFrom(
  ...
  public static emu.grasscutter.net.proto.FEJPLPGFMBM parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static emu.grasscutter.net.proto.FEJPLPGFMBM parseFrom(
  ...
  public static emu.grasscutter.net.proto.FEJPLPGFMBM parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static emu.grasscutter.net.proto.FEJPLPGFMBM parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static emu.grasscutter.net.proto.FEJPLPGFMBM parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(emu.grasscutter.net.proto.FEJPLPGFMBM prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:FEJPLPGFMBM)
      emu.grasscutter.net.proto.FEJPLPGFMBMOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.proto.Proto4_8.internal_static_FEJPLPGFMBM_descriptor;
    }
    ...
    // Construct using emu.grasscutter.net.proto.FEJPLPGFMBM.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.FEJPLPGFMBM getDefaultInstanceForType() {
      return emu.grasscutter.net.proto.FEJPLPGFMBM.getDefaultInstance();
    }

    @java.lang.Override
    public emu.grasscutter.net.proto.FEJPLPGFMBM build() {
      emu.grasscutter.net.proto.FEJPLPGFMBM result = buildPartial();
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.FEJPLPGFMBM buildPartial() {
      emu.grasscutter.net.proto.FEJPLPGFMBM result = new emu.grasscutter.net.proto.FEJPLPGFMBM(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof emu.grasscutter.net.proto.FEJPLPGFMBM) {
        return mergeFrom((emu.grasscutter.net.proto.FEJPLPGFMBM)other);
      } else {
    ...
    public Builder mergeFrom(emu.grasscutter.net.proto.FEJPLPGFMBM other) {
      if (other == emu.grasscutter.net.proto.FEJPLPGFMBM.getDefaultInstance()) return this;
      if (other.getResin() != 0) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      emu.grasscutter.net.proto.FEJPLPGFMBM parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (emu.grasscutter.net.proto.FEJPLPGFMBM) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        emu.grasscutter.net.proto.LIIBENDPBIH, emu.grasscutter.net.proto.LIIBENDPBIH.Builder, emu.grasscutter.net.proto.LIIBENDPBIHOrBuilder> itemParamBuilder_;
    /**
     * <code>.LIIBENDPBIH item_param = 5;</code>
     * @return Whether the itemParam field is set.
     */
     ...
     * <code>.LIIBENDPBIH item_param = 5;</code>
     */
    public Builder setItemParam(emu.grasscutter.net.proto.LIIBENDPBIH value) {
      if (itemParamBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.LIIBENDPBIH item_param = 5;</code>
     */
    public Builder mergeItemParam(emu.grasscutter.net.proto.LIIBENDPBIH value) {
      if (itemParamBuilder_ == null) {
        if (itemParam_ != null) {
          itemParam_ =
            emu.grasscutter.net.proto.LIIBENDPBIH.newBuilder(itemParam_).mergeFrom(value).buildPartial();
        } else {
          itemParam_ = value;
        }
        onChanged();
     ...
     * <code>.LIIBENDPBIH item_param = 5;</code>
     */
    public emu.grasscutter.net.proto.LIIBENDPBIH.Builder getItemParamBuilder() {
    ...
    public emu.grasscutter.net.proto.LIIBENDPBIHOrBuilder getItemParamOrBuilder() {
      if (itemParamBuilder_ != null) {
        ...
        return itemParam_ == null ?
            emu.grasscutter.net.proto.LIIBENDPBIH.getDefaultInstance() : itemParam_;
      }
    }
    /**
     * <code>.LIIBENDPBIH item_param = 5;</code>
    ...
    // @@protoc_insertion_point(builder_scope:FEJPLPGFMBM)
  }

  // @@protoc_insertion_point(class_scope:FEJPLPGFMBM)
  private static final emu.grasscutter.net.proto.FEJPLPGFMBM DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new emu.grasscutter.net.proto.FEJPLPGFMBM();
  }

  public static emu.grasscutter.net.proto.FEJPLPGFMBM getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<FEJPLPGFMBM>
      PARSER = new com.google.protobuf.AbstractParser<FEJPLPGFMBM>() {
    @java.lang.Override
    public FEJPLPGFMBM parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new FEJPLPGFMBM(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<FEJPLPGFMBM> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<FEJPLPGFMBM> getParserForType() {
    return PARSER;
  }
