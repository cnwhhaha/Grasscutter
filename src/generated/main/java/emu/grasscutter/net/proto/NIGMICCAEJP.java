...
/**
 * <pre>
 * CmdId: - | MergeFrom: 0xC21E4E0 | WriteTo: 0xC21D910
 * </pre>
 *
 * Protobuf type {@code NIGMICCAEJP}
 */
public final class NIGMICCAEJP extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:NIGMICCAEJP)
    NIGMICCAEJPOrBuilder {
private static final long serialVersionUID = 0L;
  // Use NIGMICCAEJP.newBuilder() to construct.
  private NIGMICCAEJP(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private NIGMICCAEJP() {
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              ballList_ = new java.util.ArrayList<emu.grasscutter.net.proto.JJANDKAOOEJ>();
              mutable_bitField0_ |= 0x00000001;
            }
            ballList_.add(
                input.readMessage(emu.grasscutter.net.proto.JJANDKAOOEJ.parser(), extensionRegistry));
            break;
          }
          case 34: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              physicalObjectList_ = new java.util.ArrayList<emu.grasscutter.net.proto.JJANDKAOOEJ>();
          ...
          case 42: {
            if (!((mutable_bitField0_ & 0x00000004) != 0)) {
              actionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.PDKGKBMPMIK>();
              mutable_bitField0_ |= 0x00000004;
            }
            actionList_.add(
                input.readMessage(emu.grasscutter.net.proto.PDKGKBMPMIK.parser(), extensionRegistry));
            break;
          }
          case 48: {
          ...
          case 106: {
            if (!((mutable_bitField0_ & 0x00000008) != 0)) {
              spawnPointList_ = new java.util.ArrayList<emu.grasscutter.net.proto.LDEINOBLJHL>();
              mutable_bitField0_ |= 0x00000008;
            }
            spawnPointList_.add(
                input.readMessage(emu.grasscutter.net.proto.LDEINOBLJHL.parser(), extensionRegistry));
            break;
          }
          case 112: {
          ...
          case 122: {
            if (!((mutable_bitField0_ & 0x00000010) != 0)) {
              brickElementReactionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.NKAMIMKMCDD>();
              mutable_bitField0_ |= 0x00000010;
            }
            brickElementReactionList_.add(
                input.readMessage(emu.grasscutter.net.proto.NKAMIMKMCDD.parser(), extensionRegistry));
            break;
          }
          case 130: {
            if (!((mutable_bitField0_ & 0x00000020) != 0)) {
              ballElementReactionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.NKAMIMKMCDD>();
          ...
          case 146: {
            if (!((mutable_bitField0_ & 0x00000080) != 0)) {
              dynamicObjectList_ = new java.util.ArrayList<emu.grasscutter.net.proto.JJANDKAOOEJ>();
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_NIGMICCAEJP_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_NIGMICCAEJP_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            emu.grasscutter.net.proto.NIGMICCAEJP.class, emu.grasscutter.net.proto.NIGMICCAEJP.Builder.class);
  }
  ...
  private java.util.List<emu.grasscutter.net.proto.JJANDKAOOEJ> ballList_;
  /**
   * <code>repeated .JJANDKAOOEJ ball_list = 3;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.JJANDKAOOEJ> getBallListList() {
    return ballList_;
  }
  /**
   * <code>repeated .JJANDKAOOEJ ball_list = 3;</code>
   */
  @java.lang.Override
  public java.util.List<? extends emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder> 
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.JJANDKAOOEJ getBallList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder getBallListOrBuilder(
      int index) {
    return ballList_.get(index);
  }

  public static final int PHYSICAL_OBJECT_LIST_FIELD_NUMBER = 4;
  private java.util.List<emu.grasscutter.net.proto.JJANDKAOOEJ> physicalObjectList_;
  /**
   * <code>repeated .JJANDKAOOEJ physical_object_list = 4;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.JJANDKAOOEJ> getPhysicalObjectListList() {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.JJANDKAOOEJ getPhysicalObjectList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder getPhysicalObjectListOrBuilder(
      int index) {
    return physicalObjectList_.get(index);
  }

  public static final int ACTION_LIST_FIELD_NUMBER = 5;
  private java.util.List<emu.grasscutter.net.proto.PDKGKBMPMIK> actionList_;
  /**
   * <code>repeated .PDKGKBMPMIK action_list = 5;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.PDKGKBMPMIK> getActionListList() {
    return actionList_;
  }
  /**
   * <code>repeated .PDKGKBMPMIK action_list = 5;</code>
   */
  @java.lang.Override
  public java.util.List<? extends emu.grasscutter.net.proto.PDKGKBMPMIKOrBuilder> 
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.PDKGKBMPMIK getActionList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.PDKGKBMPMIKOrBuilder getActionListOrBuilder(
      int index) {
    return actionList_.get(index);
  }
  ...
  private java.util.List<emu.grasscutter.net.proto.LDEINOBLJHL> spawnPointList_;
  /**
   * <code>repeated .LDEINOBLJHL spawn_point_list = 13;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.LDEINOBLJHL> getSpawnPointListList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends emu.grasscutter.net.proto.LDEINOBLJHLOrBuilder> 
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.LDEINOBLJHL getSpawnPointList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.LDEINOBLJHLOrBuilder getSpawnPointListOrBuilder(
      int index) {
    return spawnPointList_.get(index);
  }
  ...
  private java.util.List<emu.grasscutter.net.proto.NKAMIMKMCDD> brickElementReactionList_;
  /**
   * <code>repeated .NKAMIMKMCDD brick_element_reaction_list = 15;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.NKAMIMKMCDD> getBrickElementReactionListList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends emu.grasscutter.net.proto.NKAMIMKMCDDOrBuilder> 
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.NKAMIMKMCDD getBrickElementReactionList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.NKAMIMKMCDDOrBuilder getBrickElementReactionListOrBuilder(
      int index) {
    return brickElementReactionList_.get(index);
  }

  public static final int BALL_ELEMENT_REACTION_LIST_FIELD_NUMBER = 16;
  private java.util.List<emu.grasscutter.net.proto.NKAMIMKMCDD> ballElementReactionList_;
  /**
   * <code>repeated .NKAMIMKMCDD ball_element_reaction_list = 16;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.NKAMIMKMCDD> getBallElementReactionListList() {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.NKAMIMKMCDD getBallElementReactionList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.NKAMIMKMCDDOrBuilder getBallElementReactionListOrBuilder(
      int index) {
    return ballElementReactionList_.get(index);
  }
  ...
  private java.util.List<emu.grasscutter.net.proto.JJANDKAOOEJ> dynamicObjectList_;
  /**
   * <code>repeated .JJANDKAOOEJ dynamic_object_list = 18;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.JJANDKAOOEJ> getDynamicObjectListList() {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.JJANDKAOOEJ getDynamicObjectList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder getDynamicObjectListOrBuilder(
      int index) {
    return dynamicObjectList_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof emu.grasscutter.net.proto.NIGMICCAEJP)) {
      return super.equals(obj);
    }
    emu.grasscutter.net.proto.NIGMICCAEJP other = (emu.grasscutter.net.proto.NIGMICCAEJP) obj;
  ...
  public static emu.grasscutter.net.proto.NIGMICCAEJP parseFrom(
  ...
  public static emu.grasscutter.net.proto.NIGMICCAEJP parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static emu.grasscutter.net.proto.NIGMICCAEJP parseFrom(
  ...
  public static emu.grasscutter.net.proto.NIGMICCAEJP parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static emu.grasscutter.net.proto.NIGMICCAEJP parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static emu.grasscutter.net.proto.NIGMICCAEJP parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(emu.grasscutter.net.proto.NIGMICCAEJP prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:NIGMICCAEJP)
      emu.grasscutter.net.proto.NIGMICCAEJPOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.proto.Proto4_8.internal_static_NIGMICCAEJP_descriptor;
    }
    ...
    // Construct using emu.grasscutter.net.proto.NIGMICCAEJP.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.NIGMICCAEJP getDefaultInstanceForType() {
      return emu.grasscutter.net.proto.NIGMICCAEJP.getDefaultInstance();
    }

    @java.lang.Override
    public emu.grasscutter.net.proto.NIGMICCAEJP build() {
      emu.grasscutter.net.proto.NIGMICCAEJP result = buildPartial();
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.NIGMICCAEJP buildPartial() {
      emu.grasscutter.net.proto.NIGMICCAEJP result = new emu.grasscutter.net.proto.NIGMICCAEJP(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof emu.grasscutter.net.proto.NIGMICCAEJP) {
        return mergeFrom((emu.grasscutter.net.proto.NIGMICCAEJP)other);
      } else {
    ...
    public Builder mergeFrom(emu.grasscutter.net.proto.NIGMICCAEJP other) {
      if (other == emu.grasscutter.net.proto.NIGMICCAEJP.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      emu.grasscutter.net.proto.NIGMICCAEJP parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (emu.grasscutter.net.proto.NIGMICCAEJP) e.getUnfinishedMessage();
    ...
    private void ensureBallListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        ballList_ = new java.util.ArrayList<emu.grasscutter.net.proto.JJANDKAOOEJ>(ballList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.JJANDKAOOEJ, emu.grasscutter.net.proto.JJANDKAOOEJ.Builder, emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder> ballListBuilder_;
    ...
    public Builder setBallList(
        int index, emu.grasscutter.net.proto.JJANDKAOOEJ value) {
      if (ballListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setBallList(
        int index, emu.grasscutter.net.proto.JJANDKAOOEJ.Builder builderForValue) {
      if (ballListBuilder_ == null) {
        ensureBallListIsMutable();
     ...
     * <code>repeated .JJANDKAOOEJ ball_list = 3;</code>
     */
    public Builder addBallList(emu.grasscutter.net.proto.JJANDKAOOEJ value) {
      if (ballListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addBallList(
        emu.grasscutter.net.proto.JJANDKAOOEJ.Builder builderForValue) {
      if (ballListBuilder_ == null) {
        ensureBallListIsMutable();
    ...
    public Builder addAllBallList(
        java.lang.Iterable<? extends emu.grasscutter.net.proto.JJANDKAOOEJ> values) {
      if (ballListBuilder_ == null) {
        ensureBallListIsMutable();
     ...
     * <code>repeated .JJANDKAOOEJ ball_list = 3;</code>
     */
    public emu.grasscutter.net.proto.JJANDKAOOEJ.Builder getBallListBuilder(
        int index) {
     ...
     * <code>repeated .JJANDKAOOEJ ball_list = 3;</code>
     */
    public emu.grasscutter.net.proto.JJANDKAOOEJ.Builder addBallListBuilder() {
      return getBallListFieldBuilder().addBuilder(
          emu.grasscutter.net.proto.JJANDKAOOEJ.getDefaultInstance());
    }
    /**
     * <code>repeated .JJANDKAOOEJ ball_list = 3;</code>
     */
    public emu.grasscutter.net.proto.JJANDKAOOEJ.Builder addBallListBuilder(
        int index) {
      return getBallListFieldBuilder().addBuilder(
          index, emu.grasscutter.net.proto.JJANDKAOOEJ.getDefaultInstance());
    }
    /**
     * <code>repeated .JJANDKAOOEJ ball_list = 3;</code>
     */
    public java.util.List<emu.grasscutter.net.proto.JJANDKAOOEJ.Builder> 
         getBallListBuilderList() {
      return getBallListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.JJANDKAOOEJ, emu.grasscutter.net.proto.JJANDKAOOEJ.Builder, emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder> 
        getBallListFieldBuilder() {
      if (ballListBuilder_ == null) {
    ...
    private void ensurePhysicalObjectListIsMutable() {
      if (!((bitField0_ & 0x00000002) != 0)) {
        physicalObjectList_ = new java.util.ArrayList<emu.grasscutter.net.proto.JJANDKAOOEJ>(physicalObjectList_);
        bitField0_ |= 0x00000002;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.JJANDKAOOEJ, emu.grasscutter.net.proto.JJANDKAOOEJ.Builder, emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder> physicalObjectListBuilder_;
     ...
     * <code>repeated .JJANDKAOOEJ physical_object_list = 4;</code>
     */
    public Builder addPhysicalObjectList(emu.grasscutter.net.proto.JJANDKAOOEJ value) {
      if (physicalObjectListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .JJANDKAOOEJ physical_object_list = 4;</code>
     */
    public emu.grasscutter.net.proto.JJANDKAOOEJ.Builder getPhysicalObjectListBuilder(
        int index) {
     ...
     * <code>repeated .JJANDKAOOEJ physical_object_list = 4;</code>
     */
    public emu.grasscutter.net.proto.JJANDKAOOEJ.Builder addPhysicalObjectListBuilder() {
    ...
    private void ensureActionListIsMutable() {
      if (!((bitField0_ & 0x00000004) != 0)) {
        actionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.PDKGKBMPMIK>(actionList_);
        bitField0_ |= 0x00000004;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.PDKGKBMPMIK, emu.grasscutter.net.proto.PDKGKBMPMIK.Builder, emu.grasscutter.net.proto.PDKGKBMPMIKOrBuilder> actionListBuilder_;
    ...
    public Builder setActionList(
        int index, emu.grasscutter.net.proto.PDKGKBMPMIK value) {
      if (actionListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setActionList(
        int index, emu.grasscutter.net.proto.PDKGKBMPMIK.Builder builderForValue) {
      if (actionListBuilder_ == null) {
        ensureActionListIsMutable();
     ...
     * <code>repeated .PDKGKBMPMIK action_list = 5;</code>
     */
    public Builder addActionList(emu.grasscutter.net.proto.PDKGKBMPMIK value) {
      if (actionListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addActionList(
        emu.grasscutter.net.proto.PDKGKBMPMIK.Builder builderForValue) {
      if (actionListBuilder_ == null) {
        ensureActionListIsMutable();
    ...
    public Builder addAllActionList(
        java.lang.Iterable<? extends emu.grasscutter.net.proto.PDKGKBMPMIK> values) {
      if (actionListBuilder_ == null) {
        ensureActionListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, actionList_);
     ...
     * <code>repeated .PDKGKBMPMIK action_list = 5;</code>
     */
    public emu.grasscutter.net.proto.PDKGKBMPMIK.Builder getActionListBuilder(
        int index) {
     ...
     * <code>repeated .PDKGKBMPMIK action_list = 5;</code>
     */
    public emu.grasscutter.net.proto.PDKGKBMPMIK.Builder addActionListBuilder() {
      return getActionListFieldBuilder().addBuilder(
          emu.grasscutter.net.proto.PDKGKBMPMIK.getDefaultInstance());
    }
    /**
     * <code>repeated .PDKGKBMPMIK action_list = 5;</code>
     */
    public emu.grasscutter.net.proto.PDKGKBMPMIK.Builder addActionListBuilder(
        int index) {
      return getActionListFieldBuilder().addBuilder(
          index, emu.grasscutter.net.proto.PDKGKBMPMIK.getDefaultInstance());
    }
    /**
     * <code>repeated .PDKGKBMPMIK action_list = 5;</code>
     */
    public java.util.List<emu.grasscutter.net.proto.PDKGKBMPMIK.Builder> 
         getActionListBuilderList() {
      return getActionListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.PDKGKBMPMIK, emu.grasscutter.net.proto.PDKGKBMPMIK.Builder, emu.grasscutter.net.proto.PDKGKBMPMIKOrBuilder> 
        getActionListFieldBuilder() {
      if (actionListBuilder_ == null) {
    ...
    private void ensureSpawnPointListIsMutable() {
      if (!((bitField0_ & 0x00000008) != 0)) {
        spawnPointList_ = new java.util.ArrayList<emu.grasscutter.net.proto.LDEINOBLJHL>(spawnPointList_);
        bitField0_ |= 0x00000008;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.LDEINOBLJHL, emu.grasscutter.net.proto.LDEINOBLJHL.Builder, emu.grasscutter.net.proto.LDEINOBLJHLOrBuilder> spawnPointListBuilder_;
    ...
    public Builder setSpawnPointList(
        int index, emu.grasscutter.net.proto.LDEINOBLJHL value) {
      if (spawnPointListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setSpawnPointList(
        int index, emu.grasscutter.net.proto.LDEINOBLJHL.Builder builderForValue) {
      if (spawnPointListBuilder_ == null) {
        ensureSpawnPointListIsMutable();
     ...
     * <code>repeated .LDEINOBLJHL spawn_point_list = 13;</code>
     */
    public Builder addSpawnPointList(emu.grasscutter.net.proto.LDEINOBLJHL value) {
      if (spawnPointListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addSpawnPointList(
        emu.grasscutter.net.proto.LDEINOBLJHL.Builder builderForValue) {
      if (spawnPointListBuilder_ == null) {
        ensureSpawnPointListIsMutable();
    ...
    public Builder addAllSpawnPointList(
        java.lang.Iterable<? extends emu.grasscutter.net.proto.LDEINOBLJHL> values) {
      if (spawnPointListBuilder_ == null) {
        ensureSpawnPointListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
     ...
     * <code>repeated .LDEINOBLJHL spawn_point_list = 13;</code>
     */
    public emu.grasscutter.net.proto.LDEINOBLJHL.Builder getSpawnPointListBuilder(
        int index) {
     ...
     * <code>repeated .LDEINOBLJHL spawn_point_list = 13;</code>
     */
    public emu.grasscutter.net.proto.LDEINOBLJHL.Builder addSpawnPointListBuilder() {
      return getSpawnPointListFieldBuilder().addBuilder(
          emu.grasscutter.net.proto.LDEINOBLJHL.getDefaultInstance());
    }
    /**
     * <code>repeated .LDEINOBLJHL spawn_point_list = 13;</code>
     */
    public emu.grasscutter.net.proto.LDEINOBLJHL.Builder addSpawnPointListBuilder(
        int index) {
      return getSpawnPointListFieldBuilder().addBuilder(
          index, emu.grasscutter.net.proto.LDEINOBLJHL.getDefaultInstance());
    }
    /**
     * <code>repeated .LDEINOBLJHL spawn_point_list = 13;</code>
     */
    public java.util.List<emu.grasscutter.net.proto.LDEINOBLJHL.Builder> 
         getSpawnPointListBuilderList() {
      return getSpawnPointListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.LDEINOBLJHL, emu.grasscutter.net.proto.LDEINOBLJHL.Builder, emu.grasscutter.net.proto.LDEINOBLJHLOrBuilder> 
        getSpawnPointListFieldBuilder() {
      if (spawnPointListBuilder_ == null) {
    ...
    private void ensureBrickElementReactionListIsMutable() {
      if (!((bitField0_ & 0x00000010) != 0)) {
        brickElementReactionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.NKAMIMKMCDD>(brickElementReactionList_);
        bitField0_ |= 0x00000010;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.NKAMIMKMCDD, emu.grasscutter.net.proto.NKAMIMKMCDD.Builder, emu.grasscutter.net.proto.NKAMIMKMCDDOrBuilder> brickElementReactionListBuilder_;
    ...
    public Builder setBrickElementReactionList(
        int index, emu.grasscutter.net.proto.NKAMIMKMCDD value) {
      if (brickElementReactionListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setBrickElementReactionList(
        int index, emu.grasscutter.net.proto.NKAMIMKMCDD.Builder builderForValue) {
      if (brickElementReactionListBuilder_ == null) {
        ensureBrickElementReactionListIsMutable();
     ...
     * <code>repeated .NKAMIMKMCDD brick_element_reaction_list = 15;</code>
     */
    public Builder addBrickElementReactionList(emu.grasscutter.net.proto.NKAMIMKMCDD value) {
      if (brickElementReactionListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addBrickElementReactionList(
        emu.grasscutter.net.proto.NKAMIMKMCDD.Builder builderForValue) {
      if (brickElementReactionListBuilder_ == null) {
        ensureBrickElementReactionListIsMutable();
    ...
    public Builder addAllBrickElementReactionList(
        java.lang.Iterable<? extends emu.grasscutter.net.proto.NKAMIMKMCDD> values) {
      if (brickElementReactionListBuilder_ == null) {
        ensureBrickElementReactionListIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
     ...
     * <code>repeated .NKAMIMKMCDD brick_element_reaction_list = 15;</code>
     */
    public emu.grasscutter.net.proto.NKAMIMKMCDD.Builder getBrickElementReactionListBuilder(
        int index) {
     ...
     * <code>repeated .NKAMIMKMCDD brick_element_reaction_list = 15;</code>
     */
    public emu.grasscutter.net.proto.NKAMIMKMCDD.Builder addBrickElementReactionListBuilder() {
      return getBrickElementReactionListFieldBuilder().addBuilder(
          emu.grasscutter.net.proto.NKAMIMKMCDD.getDefaultInstance());
    }
    /**
     * <code>repeated .NKAMIMKMCDD brick_element_reaction_list = 15;</code>
     */
    public emu.grasscutter.net.proto.NKAMIMKMCDD.Builder addBrickElementReactionListBuilder(
        int index) {
      return getBrickElementReactionListFieldBuilder().addBuilder(
          index, emu.grasscutter.net.proto.NKAMIMKMCDD.getDefaultInstance());
    }
    /**
     * <code>repeated .NKAMIMKMCDD brick_element_reaction_list = 15;</code>
     */
    public java.util.List<emu.grasscutter.net.proto.NKAMIMKMCDD.Builder> 
         getBrickElementReactionListBuilderList() {
      return getBrickElementReactionListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.NKAMIMKMCDD, emu.grasscutter.net.proto.NKAMIMKMCDD.Builder, emu.grasscutter.net.proto.NKAMIMKMCDDOrBuilder> 
        getBrickElementReactionListFieldBuilder() {
      if (brickElementReactionListBuilder_ == null) {
    ...
    private void ensureBallElementReactionListIsMutable() {
      if (!((bitField0_ & 0x00000020) != 0)) {
        ballElementReactionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.NKAMIMKMCDD>(ballElementReactionList_);
        bitField0_ |= 0x00000020;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.NKAMIMKMCDD, emu.grasscutter.net.proto.NKAMIMKMCDD.Builder, emu.grasscutter.net.proto.NKAMIMKMCDDOrBuilder> ballElementReactionListBuilder_;
     ...
     * <code>repeated .NKAMIMKMCDD ball_element_reaction_list = 16;</code>
     */
    public Builder addBallElementReactionList(emu.grasscutter.net.proto.NKAMIMKMCDD value) {
      if (ballElementReactionListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .NKAMIMKMCDD ball_element_reaction_list = 16;</code>
     */
    public emu.grasscutter.net.proto.NKAMIMKMCDD.Builder getBallElementReactionListBuilder(
        int index) {
     ...
     * <code>repeated .NKAMIMKMCDD ball_element_reaction_list = 16;</code>
     */
    public emu.grasscutter.net.proto.NKAMIMKMCDD.Builder addBallElementReactionListBuilder() {
    ...
    private void ensureDynamicObjectListIsMutable() {
      if (!((bitField0_ & 0x00000080) != 0)) {
        dynamicObjectList_ = new java.util.ArrayList<emu.grasscutter.net.proto.JJANDKAOOEJ>(dynamicObjectList_);
        bitField0_ |= 0x00000080;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.JJANDKAOOEJ, emu.grasscutter.net.proto.JJANDKAOOEJ.Builder, emu.grasscutter.net.proto.JJANDKAOOEJOrBuilder> dynamicObjectListBuilder_;
     ...
     * <code>repeated .JJANDKAOOEJ dynamic_object_list = 18;</code>
     */
    public Builder addDynamicObjectList(emu.grasscutter.net.proto.JJANDKAOOEJ value) {
      if (dynamicObjectListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .JJANDKAOOEJ dynamic_object_list = 18;</code>
     */
    public emu.grasscutter.net.proto.JJANDKAOOEJ.Builder getDynamicObjectListBuilder(
        int index) {
     ...
     * <code>repeated .JJANDKAOOEJ dynamic_object_list = 18;</code>
     */
    public emu.grasscutter.net.proto.JJANDKAOOEJ.Builder addDynamicObjectListBuilder() {
    ...
    // @@protoc_insertion_point(builder_scope:NIGMICCAEJP)
  }

  // @@protoc_insertion_point(class_scope:NIGMICCAEJP)
  private static final emu.grasscutter.net.proto.NIGMICCAEJP DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new emu.grasscutter.net.proto.NIGMICCAEJP();
  }

  public static emu.grasscutter.net.proto.NIGMICCAEJP getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<NIGMICCAEJP>
      PARSER = new com.google.protobuf.AbstractParser<NIGMICCAEJP>() {
    @java.lang.Override
    public NIGMICCAEJP parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new NIGMICCAEJP(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<NIGMICCAEJP> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<NIGMICCAEJP> getParserForType() {
    return PARSER;
  }
