...
/**
 * <pre>
 * CmdId: - | MergeFrom: 0xA2249E0 | WriteTo: -
 * </pre>
 *
 * Protobuf type {@code CPPKPLMPBPB}
 */
public final class CPPKPLMPBPB extends
    com.google.protobuf.GeneratedMessageV3 implements
    // @@protoc_insertion_point(message_implements:CPPKPLMPBPB)
    CPPKPLMPBPBOrBuilder {
private static final long serialVersionUID = 0L;
  // Use CPPKPLMPBPB.newBuilder() to construct.
  private CPPKPLMPBPB(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  private CPPKPLMPBPB() {
        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              regionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.FNHDODALDLP>();
              mutable_bitField0_ |= 0x00000001;
            }
            regionList_.add(
                input.readMessage(emu.grasscutter.net.proto.FNHDODALDLP.parser(), extensionRegistry));
            break;
          }
          case 42: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_CPPKPLMPBPB_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return emu.grasscutter.net.proto.Proto4_8.internal_static_CPPKPLMPBPB_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            emu.grasscutter.net.proto.CPPKPLMPBPB.class, emu.grasscutter.net.proto.CPPKPLMPBPB.Builder.class);
  }
  ...
  private java.util.List<emu.grasscutter.net.proto.FNHDODALDLP> regionList_;
  /**
   * <code>repeated .FNHDODALDLP region_list = 2;</code>
   */
  @java.lang.Override
  public java.util.List<emu.grasscutter.net.proto.FNHDODALDLP> getRegionListList() {
    return regionList_;
  }
  /**
   * <code>repeated .FNHDODALDLP region_list = 2;</code>
   */
  @java.lang.Override
  public java.util.List<? extends emu.grasscutter.net.proto.FNHDODALDLPOrBuilder> 
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.FNHDODALDLP getRegionList(int index) {
   ...
   */
  @java.lang.Override
  public emu.grasscutter.net.proto.FNHDODALDLPOrBuilder getRegionListOrBuilder(
      int index) {
    return regionList_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof emu.grasscutter.net.proto.CPPKPLMPBPB)) {
      return super.equals(obj);
    }
    emu.grasscutter.net.proto.CPPKPLMPBPB other = (emu.grasscutter.net.proto.CPPKPLMPBPB) obj;
  ...
  public static emu.grasscutter.net.proto.CPPKPLMPBPB parseFrom(
  ...
  public static emu.grasscutter.net.proto.CPPKPLMPBPB parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static emu.grasscutter.net.proto.CPPKPLMPBPB parseFrom(
  ...
  public static emu.grasscutter.net.proto.CPPKPLMPBPB parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static emu.grasscutter.net.proto.CPPKPLMPBPB parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static emu.grasscutter.net.proto.CPPKPLMPBPB parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(emu.grasscutter.net.proto.CPPKPLMPBPB prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:CPPKPLMPBPB)
      emu.grasscutter.net.proto.CPPKPLMPBPBOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.proto.Proto4_8.internal_static_CPPKPLMPBPB_descriptor;
    }
    ...
    // Construct using emu.grasscutter.net.proto.CPPKPLMPBPB.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.CPPKPLMPBPB getDefaultInstanceForType() {
      return emu.grasscutter.net.proto.CPPKPLMPBPB.getDefaultInstance();
    }

    @java.lang.Override
    public emu.grasscutter.net.proto.CPPKPLMPBPB build() {
      emu.grasscutter.net.proto.CPPKPLMPBPB result = buildPartial();
    ...
    @java.lang.Override
    public emu.grasscutter.net.proto.CPPKPLMPBPB buildPartial() {
      emu.grasscutter.net.proto.CPPKPLMPBPB result = new emu.grasscutter.net.proto.CPPKPLMPBPB(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof emu.grasscutter.net.proto.CPPKPLMPBPB) {
        return mergeFrom((emu.grasscutter.net.proto.CPPKPLMPBPB)other);
      } else {
    ...
    public Builder mergeFrom(emu.grasscutter.net.proto.CPPKPLMPBPB other) {
      if (other == emu.grasscutter.net.proto.CPPKPLMPBPB.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      emu.grasscutter.net.proto.CPPKPLMPBPB parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (emu.grasscutter.net.proto.CPPKPLMPBPB) e.getUnfinishedMessage();
    ...
    private void ensureRegionListIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        regionList_ = new java.util.ArrayList<emu.grasscutter.net.proto.FNHDODALDLP>(regionList_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.FNHDODALDLP, emu.grasscutter.net.proto.FNHDODALDLP.Builder, emu.grasscutter.net.proto.FNHDODALDLPOrBuilder> regionListBuilder_;
    ...
    public Builder setRegionList(
        int index, emu.grasscutter.net.proto.FNHDODALDLP value) {
      if (regionListBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setRegionList(
        int index, emu.grasscutter.net.proto.FNHDODALDLP.Builder builderForValue) {
      if (regionListBuilder_ == null) {
        ensureRegionListIsMutable();
     ...
     * <code>repeated .FNHDODALDLP region_list = 2;</code>
     */
    public Builder addRegionList(emu.grasscutter.net.proto.FNHDODALDLP value) {
      if (regionListBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder addRegionList(
        emu.grasscutter.net.proto.FNHDODALDLP.Builder builderForValue) {
      if (regionListBuilder_ == null) {
        ensureRegionListIsMutable();
    ...
    public Builder addAllRegionList(
        java.lang.Iterable<? extends emu.grasscutter.net.proto.FNHDODALDLP> values) {
      if (regionListBuilder_ == null) {
        ensureRegionListIsMutable();
     ...
     * <code>repeated .FNHDODALDLP region_list = 2;</code>
     */
    public emu.grasscutter.net.proto.FNHDODALDLP.Builder getRegionListBuilder(
        int index) {
     ...
     * <code>repeated .FNHDODALDLP region_list = 2;</code>
     */
    public emu.grasscutter.net.proto.FNHDODALDLP.Builder addRegionListBuilder() {
      return getRegionListFieldBuilder().addBuilder(
          emu.grasscutter.net.proto.FNHDODALDLP.getDefaultInstance());
    }
    /**
     * <code>repeated .FNHDODALDLP region_list = 2;</code>
     */
    public emu.grasscutter.net.proto.FNHDODALDLP.Builder addRegionListBuilder(
        int index) {
      return getRegionListFieldBuilder().addBuilder(
          index, emu.grasscutter.net.proto.FNHDODALDLP.getDefaultInstance());
    }
    /**
     * <code>repeated .FNHDODALDLP region_list = 2;</code>
     */
    public java.util.List<emu.grasscutter.net.proto.FNHDODALDLP.Builder> 
         getRegionListBuilderList() {
      return getRegionListFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        emu.grasscutter.net.proto.FNHDODALDLP, emu.grasscutter.net.proto.FNHDODALDLP.Builder, emu.grasscutter.net.proto.FNHDODALDLPOrBuilder> 
        getRegionListFieldBuilder() {
      if (regionListBuilder_ == null) {
    ...
    // @@protoc_insertion_point(builder_scope:CPPKPLMPBPB)
  }

  // @@protoc_insertion_point(class_scope:CPPKPLMPBPB)
  private static final emu.grasscutter.net.proto.CPPKPLMPBPB DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new emu.grasscutter.net.proto.CPPKPLMPBPB();
  }

  public static emu.grasscutter.net.proto.CPPKPLMPBPB getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<CPPKPLMPBPB>
      PARSER = new com.google.protobuf.AbstractParser<CPPKPLMPBPB>() {
    @java.lang.Override
    public CPPKPLMPBPB parsePartialFrom(
        com.google.protobuf.CodedInputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return new CPPKPLMPBPB(input, extensionRegistry);
    }
  };

  public static com.google.protobuf.Parser<CPPKPLMPBPB> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<CPPKPLMPBPB> getParserForType() {
    return PARSER;
  }
