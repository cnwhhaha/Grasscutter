    ...
    public void execute(Player sender, Player targetPlayer, List<String> args) {
        ...
        if (targetPlayer.getWorld().getSceneById(sceneId) == null) {
            CommandHandler.sendMessage(
                    sender, "teleportation failed! wrong or non-existent sceneID (error: sceneid is null)");
        } else {
            ...
            if (config == null) {
                CommandHandler.sendMessage(
                        sender,
                        "teleportation failed! teleportation positions do not exist in the corresponding scene file! cannot teleport to scene (try manually with /tp instead)");
            } else {
                ...
                if (!result) {
                    ...
                    Position teleportedpos =
                            targetPlayer.getPosition(); // get player position after teleportation
